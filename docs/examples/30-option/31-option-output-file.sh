...
# Option: --output-file
#
# This example demonstrates writing output to a file.
...
OUTPUT_FILE="${OUTPUT_DIR}/output.rst"

# take care with the nested quotes
CMD_LINE_TEXT_A=$(printf 'pip-licenses %s' "--format=rst --output-file=\"$OUTPUT_FILE\"" ;)
CMD_LINE_TEXT_B=$(printf 'cat %s' "\"${OUTPUT_FILE}\"" ;)

# Run the example - output to file
run_command "${CMD_LINE_TEXT_A}"
pause 0.9

# Display the generated file
run_command "${CMD_LINE_TEXT_B}"
pause 2.2
