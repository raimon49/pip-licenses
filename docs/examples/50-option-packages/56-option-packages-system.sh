...
# Option: --with-system
#
# This example demonstrates including system packages in the output.
# By default, system packages (pip, setuptools) and tool packages (pip-licenses, prettytable, wcwidth)
